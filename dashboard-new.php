    ...
    <div class="dashboard-app">
        ...
        <nav class="dashboard-sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="chat-new.php" class="menu-item">
                    <i class="fas fa-comments"></i>
                    <span>Chat</span>
                </a>
            ...
            <div class="dashboard-content">
                ...
                <section class="content-section active" id="overviewSection">
                    <div class="welcome-banner">
                        ...
                        <div class="banner-actions">
                            <a href="chat-new.php" class="primary-btn">
                                <i class="fas fa-comments"></i>
                                Start Chatting
                            </a>
                        </div>
                                ...
                                <div class="activity-list" id="activityList">
                                    ...
                                    <div class="activity-item">
                                        <div class="activity-avatar">
                                            <img src="<?php echo htmlspecialchars($message['avatar'] ?? 'assets/images/default-avatar.svg'); ?>" 
                                                 alt="<?php echo htmlspecialchars($message['display_name'] ?? $message['username']); ?>">
                                        </div>
                                        <div class="activity-content">
                                            <div class="activity-text">
                                                <strong><?php echo htmlspecialchars($message['display_name'] ?? $message['username']); ?></strong>
                                                sent a message
                                            </div>
                                            <div class="activity-time"><?php echo date('M j, g:i A', strtotime($message['created_at'])); ?></div>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <div class="user-list" id="onlineUsersList">
                                    ...
                                    <div class="user-item" onclick="startChat(<?php echo $user['id']; ?>)">
                                        <div class="user-avatar">
                                            <img src="<?php echo htmlspecialchars($user['avatar'] ?? 'assets/images/default-avatar.svg'); ?>" 
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="card-content">
                                <div class="quick-actions">
                                    <button class="quick-action" onclick="location.href='chat-new.php'">
                                        <i class="fas fa-comments"></i>
                ...
                <section class="content-section" id="messagesSection">
                    <div class="section-header">
                        <h2>Messages</h2>
                        <button class="primary-btn" onclick="location.href='chat-new.php'">

...
$additionalJS = ['assets/js/modern-chat.js', 'assets/js/emoji.js', 'assets/js/message-reactions.js', 'assets/js/group-chat.js', 'assets/js/missing-functions.js', 'assets/js/chat-extensions.js', 'assets/js/chat-fix.js'];

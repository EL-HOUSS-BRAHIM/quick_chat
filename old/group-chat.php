        ...
        <aside class="chat-sidebar">
            ...
            <div class="sidebar-search">
                <div class="search-container">
                    ...
                    <input type="text" id="searchInput" placeholder="Search groups..." autocomplete="off" aria-label="Search groups...">
                </div>
            </div>
                ...
                <div class="tab-content" id="settingsTab">
                    <div class="settings-panel">
                        <div class="setting-item">
                            <h4>Notifications</h4>
                            <label class="toggle">
                                <input type="checkbox" id="notificationToggle" checked aria-label="checkbox input">
                        ...
                        <div class="setting-item">
                            <h4>Sound Effects</h4>
                            <label class="toggle">
                                <input type="checkbox" id="soundToggle" checked aria-label="checkbox input">
                                <span class="slider"></span>
                            </label>
                        </div>
                        <div class="setting-item">
                ...
                <header class="chat-header">
                    <div class="chat-info">
                        ...
                        <div class="chat-avatar">
                            <img src="<?php echo htmlspecialchars($group['avatar'] ?? 'assets/images/default-group.svg'); ? alt="Image">" 
                ...
                <form id="newGroupForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="member-search">
                            <input type="text" id="memberSearchInput" placeholder="Search users to add..." aria-label="Search users to add...">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="invite-link-container">
                        <input type="text" id="inviteLink" readonly aria-label="text input">
                ...
                <div class="form-group">
                    ...
                    <div class="member-search">
                        <input type="text" id="inviteSearchInput" placeholder="Search users to invite..." aria-label="Search users to invite...">
                    </div>

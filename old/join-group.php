                        ...
                        <div class="row">
                            <div class="col-md-4 text-center mb-3">
                                <?php if ($invite['avatar']): ?>
                                    <img src="<?php echo htmlspecialchars($invite['avatar']); ? alt="Image">" alt="Group Avatar" class="img-fluid rounded-circle mb-3" style="max-width: 150px;">
                                <?php else: ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <form method="post">
                                    <input type="hidden" name="csrf_token" value="<?php echo $security- aria-label="csrf token">generateCSRFToken(); ?>">

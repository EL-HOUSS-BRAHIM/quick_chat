...
$pag                    <div class="profile-avatar">
                        <img src="<?php echo htmlspecialchars($currentUser['avatar'] ?? 'assets/images/default-avatar.svg'); ? alt="Image">" 
                             alt="Your profile picture">
                        <div class="status-indicator online"></div>ss = 'modern-chat-page private-chat-page';
...
$additionalJS = ['assets/js/modern-chat.js', 'assets/js/emoji.js', 'assets/js/message-reactions.js', 'assets/js/private-chat.js', 'assets/js/chat-compatibility.js'];

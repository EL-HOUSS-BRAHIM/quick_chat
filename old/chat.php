...
<a href="#navigation" class="skip-link">Skip to navigation</a>">
        ...
        <aside class="chat-sidebar">
            ...
            <div class="sidebar-search">
                <div class="search-container">
                    ...
                    <input type="text" id="searchInput" placeholder="Search conversations..." autocomplete="off" aria-label="Search conversations...">
                </div>
            </div>
                ...
                <div class="tab-content" id="settingsTab">
                    <div class="settings-panel">
                        <div class="setting-item">
                            <label>
                                <input type="checkbox" id="notificationsEnabled" aria-label="checkbox input">
                                <span>Enable notifications</span>
                            </label>
                        </div>
                        <div class="setting-item">
                            <label>
                                <input type="checkbox" id="soundEnabled" aria-label="checkbox input">
                ...
                <header class="chat-header">
                    <div class="chat-info">
                        ...
                        <div class="chat-avatar">
                            <img src="<?php echo htmlspecialchars($targetUser['avatar'] ?? 'assets/images/default-avatar.svg'); ? alt="Image">" 
    ...
    <!-- Hidden file input -->
    <input type="file" id="fileInput" style="display: none;" multiple aria-label="file input">
    ...
    <div class="modal" id="newChatModal" onclick="closeModal(event)">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="search-container">
                    <i class="fas fa-search"></i>
                    <input type="text" id="userSearchInput" placeholder="Search users..." autocomplete="off" aria-label="Search users...">
                </div>
            ...
            <div class="modal-body">
                <form id="newGroupForm">
                    <div class="form-group">
                        ...
                        <input type="text" id="groupName" name="groupName" required placeholder="Enter group name" aria-label="Enter group name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="avatar-upload">
                            <input type="file" id="groupAvatarInput" accept="image/*" style="display: none;" aria-label="file input">
                    ...
                    <div class="form-group">
                        ...
                        <div class="member-search">
                            <input type="text" id="memberSearch" placeholder="Search users..." aria-label="Search users...">
                        </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="invite-link-container">
                        <input type="text" id="inviteLinkInput" readonly aria-label="text input">
                ...
                <div class="form-group">
                    ...
                    <div class="member-search">
                        <input type="text" id="inviteUserSearch" placeholder="Search users..." aria-label="Search users...">
                    </div>

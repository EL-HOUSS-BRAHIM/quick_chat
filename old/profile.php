    ...
    <div id="profileTab" class="tab-content active">
        <div class="section-card">
            ...
            <form method="POST" enctype="multipart/form-data" class="profile-form">
                <input type="hidden" name="action" value="update_profile" aria-label="action">
                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ? aria-label="csrf token">">
                ...
                <div class="avatar-section">
                    ...
                    <div class="avatar-controls">
                        ...
                        <input type="file" id="avatarUpload" name="avatar" accept="image/*" style="display: none;" aria-label="avatar">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="username" value="<?php echo htmlspecialchars($currentUser['username']); ? aria-label="text input">" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="display_name" name="display_name" 
                               value="<?php echo htmlspecialchars($currentUser['display_name'] ?? $currentUser['username']); ? aria-label="display name">" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" 
                               value="<?php echo htmlspecialchars($currentUser['email']); ? aria-label="email">" 
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo date('F j, Y', strtotime($currentUser['created_at'])); ? aria-label="text input">" disabled>
                    </div>
                </div>
    ...
    <div id="securityTab" class="tab-content">
        <div class="section-card">
            ...
            <form method="POST" class="security-form">
                <input type="hidden" name="action" value="change_password" aria-label="action">
                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ? aria-label="csrf token">">
                
                <div class="form-group">
                    <label for="current_password">Current Password</label>
                    <div class="password-input">
                        <input type="password" id="current_password" name="current_password" required aria-label="current password">
                ...
                <div class="form-group">
                    ...
                    <div class="password-input">
                        <input type="password" id="new_password" name="new_password" required minlength="8" aria-label="new password">
                ...
                <div class="form-group">
                    ...
                    <div class="password-input">
                        <input type="password" id="confirm_password" name="confirm_password" required minlength="8" aria-label="confirm password">
    ...
    <div id="settingsTab" class="tab-content">
        <div class="section-card">
            ...
            <form method="POST" class="settings-form">
                <input type="hidden" name="action" value="update_settings" aria-label="action">
                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ? aria-label="csrf token">">
                        ...
                        <div class="setting-item">
                            <label class="switch">
                                <input type="checkbox" name="notifications_sound" 
                                       <?php echo (!empty($userSettings['notifications_sound'])) ? 'checked' : ''; ? aria-label="notifications sound">>
                        ...
                        <div class="setting-item">
                            <label class="switch">
                                <input type="checkbox" name="notifications_desktop" 
                                       <?php echo (!empty($userSettings['notifications_desktop'])) ? 'checked' : ''; ? aria-label="notifications desktop">>
                                <span class="slider"></span>
                            </label>
                            <div class="setting-info">
                        ...
                        <div class="setting-item">
                            <label class="switch">
                                <input type="checkbox" name="notifications_email" 
                                       <?php echo (!empty($userSettings['notifications_email'])) ? 'checked' : ''; ? aria-label="notifications email">>
                                <span class="slider"></span>
                            </label>
                            <div class="setting-info">

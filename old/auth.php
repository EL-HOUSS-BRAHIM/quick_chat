...
<body class="auth-page">
    <div class="auth-container">
        ...
        <form id="loginForm" class="auth-form active" action="api/auth.php" method="POST">
            <input type="hidden" name="action" value="login" aria-label="action">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ? aria-label="csrf token">">
            
            <div class="form-group">
                <label for="login_username">Username</label>
                <input type="text" id="login_username" name="username" required minlength="3" maxlength="20" autocomplete="username" aria-label="username">
            </div>
            
            <div class="form-group">
                <label for="login_password">Password</label>
                <div class="password-input">
                    <input type="password" id="login_password" name="password" required minlength="6" autocomplete="current-password" aria-label="password">
            ...
            <div class="form-group">
                <label class="checkbox-label">
                    <input type="checkbox" name="remember_me" aria-label="remember me">
        ...
        <form id="registerForm" class="auth-form" action="api/auth.php" method="POST">
            <input type="hidden" name="action" value="register" aria-label="action">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ? aria-label="csrf token">">
            
            <div class="form-group">
                <label for="register_username">Username</label>
                <input type="text" id="register_username" name="username" required minlength="3" maxlength="20" autocomplete="username" aria-label="username">
            </div>
            
            <div class="form-group">
                <label for="register_email">Email</label>
                <input type="email" id="register_email" name="email" required autocomplete="email" aria-label="email">
            </div>
            
            <div class="form-group">
                <label for="register_password">Password</label>
                <div class="password-input">
                    <input type="password" id="register_password" name="password" required minlength="8" autocomplete="new-password" aria-label="password">
            ...
            <div class="form-group">
                ...
                <div class="password-input">
                    <input type="password" id="confirm_password" name="confirm_password" required minlength="8" autocomplete="new-password" aria-label="confirm password">
        ...
        <form id="forgotForm" class="auth-form" action="api/auth.php" method="POST">
            <input type="hidden" name="action" value="reset_password" aria-label="action">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ? aria-label="csrf token">">
            
            <div class="form-group">
                <label for="reset_email">Email Address</label>
                <input type="email" id="reset_email" name="email" required autocomplete="email" aria-label="email">
